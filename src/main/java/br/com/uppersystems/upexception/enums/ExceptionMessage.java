...
public enum ExceptionMessage {
    ...
    @Getter
    private Class<? extends UpException> klass;

    ExceptionMessage(int httpCode, String message, Class<? extends UpException> klass) {

        this.httpCode = httpCode;
        this.defaultMessage = message;
        this.klass = klass;
        this.message = ObjectUtils.isEmpty(this.message) ? this.defaultMessage.replace("{}", "") : this.message;
    }
     ...
     *
     * @param dynamicText This parameter will replace the symbols: {}, included in the message respectively. If more than one symbol is given: {}, and only one parameter pass, it will replace all the keys for the parameter entered.
     */
